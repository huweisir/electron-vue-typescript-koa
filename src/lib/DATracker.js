var env = 'prod'
console.log("DATracker", window.DATracker);
if (env === 'prod') {
    /**
    ...
    (function (h, a) {
        if (!a.__SV) {
            ...
            try {
                ...
                e && c(e, "state") && (i = JSON.parse(decodeURIComponent(c(e, "state"))), "mpeditor" === i.action && (b.sessionStorage.setItem("_mpcehash", e), history.replaceState(i.desiredHash || "", h.title, j.pathname + j.search)))
            } catch (m) {}
            var k, g;
            window.DATracker = a;
            a._i = [];
